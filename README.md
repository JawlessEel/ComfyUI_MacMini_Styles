# ComfyUI Mac Mini Styles

Local ComfyUI style/config assets for Mac Mini and ASUS ComfyUI installs.
...
From this repo folder:
    ...
    ./scripts/install_was_styles_mac.sh

Then restart ComfyUI.

## Windows / ASUS install

From PowerShell inside this repo folder:

    .\scripts\install_was_styles_windows.ps1
